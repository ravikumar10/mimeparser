...
public class InternetAddress extends Address {
    ...
    public static void main(String[] args) {
    	...
    	String address = "Zbigniew Artemiuk <sdsdss>";
		String address2 = "zbychu@fds\fds.pl";
		String address3 = "Zbigniew Artemiuk <zbychuastronet.pl>, Zbigniew Artemiuk <zbychu@astronet.pl>";
		...
		System.out.println("Personal: " + ia.getPersonal() + " endodedpersonal " + ia.getPersonal()
				+ " address " + ia.getAddress());
		
		InternetAddress[] internetAddresses = null;
		try {
			internetAddresses = InternetAddress.parse(address3);
		} catch (AddressException e) {
			e.printStackTrace();
		}
