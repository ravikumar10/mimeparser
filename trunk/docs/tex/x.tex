...
wiadomo¶ci lub jej przepuszczenie) na podstawie regu³, które zosta³y stworzone
w trakcie ³adowania konfiguracji. Wiadomo¶æ dostarczana do analizatora zostaje
oczywi¶cie wcze¶niej sparsowana przez modu³a parsuj±cy wiadomo¶ci. Posiada ona
odpowiedni± strukturê, która u³atwia jej analizê. 
Analizator jest wiêc elementem spajaj±cym regu³y, które s± jego elementem
nieodzownym elementem, oraz sparsowan± wiadomo¶æ.
Analizator jest reprezentowany przez klasê Analizer.
